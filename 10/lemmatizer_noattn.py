...
class Network(tf.keras.Model):
    def __init__(self, args, train):
        ...
        #print("self.target_mapping.vocab_size() ", self.target_mapping.vocab_size())
        ...
        #print("self.target_mapping_inverse.vocab_size() ", self.target_mapping_inverse.vocab_size())
        # TODO: Define
        ...
        #print("self.target_output_layer ", self.target_output_layer)
        # Compile the model
        self.compile(
    ...
    class DecoderTraining(tfa.seq2seq.BaseDecoder):
        ...
        def batch_size(self):
            ...
            #print("[self.source_states.shape[0]] ", [self.source_states.shape[0]])
    ...
    def call(self, inputs, targets=None):
        ...
        embedded_source = self.source_embeddings(source_charseqs)
        #print("embedded_source ", embedded_source.shape)
        # TODO: Run source_rnn on the embedded sequences, returning outputs in `source_states`.
        source_states = self.source_rnn(embedded_source)
        #print("source_states ", source_states.shape)
        #print("target_charseqs ", target_charseqs.shape)
