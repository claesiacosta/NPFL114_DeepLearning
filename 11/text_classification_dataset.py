...
class TextClassificationDataset:
    ...
    def __init__(self, name, tokenizer=None):
        ...
        self.train: TextClassificationDataset.Dataset = self.train
        self.dev: TextClassificationDataset.Dataset = self.dev
        self.test: TextClassificationDataset.Dataset = self.test
