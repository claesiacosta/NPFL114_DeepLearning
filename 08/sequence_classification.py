...
class Network(tf.keras.Model):
    def __init__(self, args):
        ...
        if args.rnn_cell == "SimpleRNN":
            hidden = tf.keras.layers.SimpleRNN(args.rnn_cell_dim, return_sequences = True)(sequences)
        elif args.rnn_cell == "LSTM":
            hidden = tf.keras.layers.LSTM(args.rnn_cell_dim, return_sequences = True)(sequences)
        elif args.rnn_cell == "GRU":
            hidden = tf.keras.layers.GRU(args.rnn_cell_dim, return_sequences = True)(sequences)
