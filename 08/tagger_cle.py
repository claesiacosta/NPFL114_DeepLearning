...
# TODO: With a probability of `args.word_masking`, replace the input word by an
        ...
        chars_id = train.forms.char_mapping(chars_seq)
        ...
        hidden_char = tf.keras.layers.Bidirectional(hidden_char)(embed_chars)
        ...
        hidden = tf.keras.layers.Bidirectional(hidden, merge_mode="sum")(concat_embed)
